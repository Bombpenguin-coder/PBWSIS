...
@section('content')
    ...
    <div class="bg-[#18191c] p-6 rounded-xl shadow-sm border border-zinc-800">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
           ...
           <button type="button" onclick="openAddDiscountModal()" class="bg-brand-orange hover:bg-brand-orange-hover text-white font-semibold py-2 px-4 rounded-lg shadow-sm transition duration-150 text-xs flex items-center gap-1.5">
