...
@section('content')
                ...
                <tbody class="divide-y divide-gray-100 text-sm bg-white">
                    @forelse($discounts as $discount)
                        <tr class="hover:bg-gray-50/80 transition duration-150">
                            ...
                            <td class="p-3">
                                <span class="px-2 py-1 text-xs font-medium rounded-full {{ $discount->is_active ? 'bg-emerald-100 text-emerald-800' : 'bg-gray-100 text-gray-800' }}">
    ...
    <!-- ================= ADD DISCOUNT MODAL ================= -->
    <div id="addDiscountModal" class="fixed inset-0 bg-black/40 backdrop-blur-sm hidden flex items-center justify-center p-4 z-50">
