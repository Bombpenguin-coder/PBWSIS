...
@section('content')
    ...
    <div class="max-w-xl bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div class="border-b pb-4 mb-5">
            <h2 class="text-lg font-bold text-gray-800">Tax & VAT Rules</h2>
            <p class="text-xs text-gray-500">Configure global VAT rate and calculation behavior across sales</p>
        </div>
        ...
        <form action="{{ route('vat.update', $vat->id) }}" method="POST">
            ...
            <!-- VAT Rate Field -->
            <div class="mb-5">
                <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1" for="rate">
                    VAT Rate (%)
                </label>
                <div class="relative">
                    <input type="number" step="0.01" name="rate" id="rate" value="{{ old('rate', $vat->rate) }}" required
                           class="w-full border border-gray-300 p-2.5 text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-red-900 focus:border-transparent pr-8">
            ...
            <div class="space-y-3 mb-6 bg-gray-50 p-4 rounded-lg border border-gray-100">
                <div class="flex items-center gap-2.5">
                    <input type="checkbox" name="is_inclusive" id="is_inclusive" value="1" 
                           ...
                           class="w-4 h-4 rounded text-red-900 focus:ring-red-900 border-gray-300">
                    <label for="is_inclusive" class="text-xs font-semibold text-gray-700 cursor-pointer">
                ...
                <div class="flex items-center gap-2.5">
                    <input type="checkbox" name="is_active" id="is_active" value="1" 
                           ...
                           class="w-4 h-4 rounded text-red-900 focus:ring-red-900 border-gray-300">
                    <label for="is_active" class="text-xs font-semibold text-gray-700 cursor-pointer">
            ...
            <div class="flex justify-end pt-3 border-t">
                <button type="submit" class="bg-red-900 hover:bg-red-800 text-white font-bold py-2 px-5 rounded-lg shadow-sm transition duration-150 text-xs">
                    Save Changes
                </button>
            </div>
        </form>
