...
<body class="bg-brand-dark text-white font-sans antialiased flex h-screen overflow-hidden selection:bg-brand-orange selection:text-white">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <div>
                ...
                <div id="fileMenu" class="{{ request()->routeIs('categories.*', 'inventory', 'discounts.*', 'vat.*', 'purchases.*', 'suppliers.*') ? '' : 'hidden' }} pl-4 pr-2 py-2 mt-1 space-y-1 bg-[#202226] rounded-lg border-l-2 border-rose-500 ml-2">
                    <a href="{{ route('categories.index') }}" class="block px-4 py-2 text-sm rounded-md transition duration-200 {{ request()->routeIs('categories.*') ? 'text-white font-bold bg-rose-700 shadow-sm' : 'text-zinc-300 hover:text-white hover:bg-zinc-800' }}">Categories</a>
                    <a href="{{ route('inventory') }}" class="block px-4 py-2 text-sm rounded-md transition duration-200 {{ request()->routeIs('inventory') ? 'text-white font-bold bg-rose-700 shadow-sm' : 'text-zinc-300 hover:text-white hover:bg-zinc-800' }}">Products Catalog</a>
                    <a href="{{ route('discounts.index') }}" class="block px-4 py-2 text-sm rounded-md transition duration-200 {{ request()->routeIs('discounts.*') ? 'text-white font-bold bg-rose-700 shadow-sm' : 'text-zinc-300 hover:text-white hover:bg-zinc-800' }}">Discounts</a>
                    <a href="{{ route('vat.index') }}" class="block px-4 py-2 text-sm rounded-md transition duration-200 {{ request()->routeIs('vat.*') ? 'text-white font-bold bg-rose-700 shadow-sm' : 'text-zinc-300 hover:text-white hover:bg-zinc-800' }}">VAT</a>
                    <a href="{{ route('purchases.index') }}" class="block px-4 py-2 text-sm rounded-md transition duration-200 {{ request()->routeIs('purchases.*') ? 'text-white font-bold bg-rose-700 shadow-sm' : 'text-zinc-300 hover:text-white hover:bg-zinc-800' }}">Purchases</a>
                    <a href="{{ route('suppliers.index') }}" class="block px-4 py-2 text-sm rounded-md transition duration-200 {{ request()->routeIs('suppliers.*') ? 'text-white font-bold bg-rose-700 shadow-sm' : 'text-zinc-300 hover:text-white hover:bg-zinc-800' }}">Suppliers</a>
                </div>
            </div>
    ...
    <div class="flex-1 flex flex-col h-screen overflow-y-auto w-full bg-brand-dark">
        ...
        <header class="bg-[#18191c] border-b border-zinc-800 sticky top-0 z-30 shadow-sm">
    ...
    <div id="editModal" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div class="bg-[#18191c] border border-zinc-800 rounded-xl shadow-2xl max-w-md w-full p-6 text-white">
            <div class="flex justify-between items-center mb-4 border-b border-zinc-800 pb-3">
                ...
                <button type="button" onclick="closeEditModal()" class="text-zinc-400 hover:text-white text-xl leading-none">&times;</button>
            </div>
